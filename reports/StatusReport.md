...
Original timeline to reference:
...
- **Week 3-4:** Data cleaning, profiling, initial exploration, check inconsistencies → Isha
  artifacts/code to include: raw datasets, notebook with data loading, cleaning, missing value checks basic profiling, etc, with time maybe add a workflow diagram with a flowchart including the data cleaning steps??
